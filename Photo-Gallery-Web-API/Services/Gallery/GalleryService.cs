...
namespace Photo_Gallery_Web_API.Services.Gallery
{
    public class GalleryService : IGalleryService
    {
        ...
        public IEnumerable<string> GetAllMyAlbums(Guid userId)
        {
            string userFolderName = userId.ToString();
            string userFolderPath = Path.Combine(_rootFolderPath, userFolderName);
            ...
            var albumDirectories = Directory.GetDirectories(userFolderPath);

            // Extract album names from full directory paths
            var albumNames = albumDirectories.Select(dir => Path.GetFileName(dir));
